...
public class ShellView
  ...
  public void createView() {
    ...
    westData.setMargins(new Margins(12, 0, 12 , 12));
    container.setWestWidget(navigation,
                            westData);
    content = new ContentPanel();
    content.setHeading(SafeHtmlUtils.fromTrustedString("Content"));
    content.setBodyStyle("background: white; padding: 12px;");
