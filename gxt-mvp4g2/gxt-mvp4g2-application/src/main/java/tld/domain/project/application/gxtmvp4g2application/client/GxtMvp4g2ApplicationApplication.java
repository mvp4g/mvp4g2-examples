 ...
 */
@Application(
    eventBus = GxtMvp4g2ApplicationEventBus.class,
    loader = GxtMvp4g2ApplicationLoader.class,
    historyOnStart = true
)
public interface GxtMvp4g2ApplicationApplication extends IsApplication {
}
