package com.github.mvp4g2.application.gxtmvp4g2application.client;
...
import com.github.mvp4g2.application.gxtmvp4g2application.client.history.DefaultHistoryConverter;
import com.github.mvp4g2.application.gxtmvp4g2application.client.ui.header.HeaderPresenter;
import com.github.mvp4g2.application.gxtmvp4g2application.client.ui.navigation.NavigationPresenter;
import com.github.mvp4g2.application.gxtmvp4g2application.client.ui.shell.ShellPresenter;
import com.github.mvp4g2.application.gxtmvp4g2application.client.ui.statusbar.StatusbarPresenter;
...
public interface GxtMvp4g2ApplicationEventBus
  extends IsEventBus {
  /**
  ...
  @Start
  @Event(
    bind = {NavigationPresenter.class,
            HeaderPresenter.class,
            StatusbarPresenter.class}
  )
  void start();
