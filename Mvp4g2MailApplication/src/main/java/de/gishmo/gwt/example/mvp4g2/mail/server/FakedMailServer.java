...
public class FakedMailServer
  ...
  private final String[] fragments = new String[]{
    ...
    + "STK- PIFR<br>" + "Current Price: .20<br>" + "This one went to $2.80 during the last marketing Campaign!",
    ...
    + "REF NUMBER: 14235/089.<br>" + "BATCH NUMBER: 304/64780/IFY.<br>" + "RE/AWARD NOTIFICATION<br>",
    ...
    + "Your email address emerged alongside TWO others as a category B winner " + "in this year\'s Annual GOVERNING AWARD Draw.<br>",
    ">> obrigado por me dar esta pequena aten??o !!!<br>" + "CASO GOSTE DE ASSISTIR TV , MAS A SUA ANTENA S? PEGA AQUELES CANAIS "
